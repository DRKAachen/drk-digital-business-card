...
- **Fotos**: Upload von Profilfotos (JPEG, PNG, WebP) mit clientseitigem Quadrat-Crop, automatischer Optimierung vor dem Upload sowie nachträglicher Bearbeitung bestehender Fotos (im aktuellen Bearbeitungsvorgang nicht-destruktiv aus demselben Quellbild); finale Upload-Datei bleibt auf max. 2 MB begrenzt
